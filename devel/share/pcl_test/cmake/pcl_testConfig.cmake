...
if("TRUE" STREQUAL "TRUE")
  set(pcl_test_SOURCE_PREFIX /home/ldp/pcl_ws/src/pcl_test)
  set(pcl_test_DEVEL_PREFIX /home/ldp/pcl_ws/devel)
  set(pcl_test_INSTALL_PREFIX "")
  set(pcl_test_PREFIX ${pcl_test_DEVEL_PREFIX})
else()
  set(pcl_test_SOURCE_PREFIX "")
  set(pcl_test_DEVEL_PREFIX "")
  set(pcl_test_INSTALL_PREFIX /home/ldp/pcl_ws/install)
...
if(NOT "/home/ldp/pcl_ws/src/pcl_test/include " STREQUAL " ")
  set(pcl_test_INCLUDE_DIRS "")
  set(_include_dirs "/home/ldp/pcl_ws/src/pcl_test/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'ldp <ldp@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcl_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ldp/pcl_ws/src/pcl_test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ldp/pcl_ws/devel/lib;/opt/ros/kinetic/lib)
